package com.qiangshijituan.zzq_jianbao.utils;
...
//Type是所有类的类型包括Javabeen
    ...
    /*
    这个类可以传递文字和图片 这个可以传递一张图片
     */
    public static void postMuti(Map<String, String> map, String path, final Context context, final Type cla, String imgs) {
...
//                .build();
        ...
        if (imgs != null && !imgs.isEmpty()) {
            //for (String str:imgs) {
            String newStr = imgs.replace("file://", "");
...
//            }
    ...
    /*
    这个类可以传递文字和图片 这个可以传递多张图片
    */
    public static void postMuti2(Map<String, String> map, String path, final Context context, final Type cla, ArrayList<String> imgs) {
